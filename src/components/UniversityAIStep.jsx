    ...
    <section className="py-24 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          >
            <span className="uppercase tracking-[0.3em] text-blue-400/70 text-sm font-bold block mb-4">
              POWERED BY
            </span>
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-400 text-base border-l-2 border-blue-500/30 pl-4 italic">
          ...
          <div className="flex flex-col gap-8 mt-10 relative">
            ...
            {cards.map((card, index) => (
              <motion.div
                ...
                className="flex items-start gap-5 group transition-all duration-200 hover:translate-x-1"
              >
                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-blue-500/10 flex items-center justify-center text-blue-400 shadow-[0_0_15px_rgba(59,130,246,0.2)] group-hover:scale-110 transition-transform duration-300">
                  <card.icon size={20} />
                </div>
                <div>
