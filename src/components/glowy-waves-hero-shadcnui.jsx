...
const highlightPills = ["Immersive visuals", "Responsive motion", "GPU friendly"];
  ...
  return (
    <section
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none">
        ...
        <div
          className="absolute top-1/2 left-1/4 h-[400px] w-[400px] rounded-full bg-primary/[0.02] blur-[150px] dark:bg-primary/[0.05]" />
      </div>
      <div
